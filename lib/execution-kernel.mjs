...
export function qualityCheck(result,plan){
  ...
  const structuralReasons=['missing_company_substance','missing_lead_substance','missing_research_substance','missing_build_substance','missing_optimization_substance','missing_artifact_substance'];
