...
export function providerConfigSnapshot(){
  ...
  return {
    ...
    openrouter:{configured:Boolean(openrouter.base&&openrouter.key),base:openrouter.base||null,fallbackModel:defaultModelFor('frontier_escalation')},
...
function requestBodyFor({provider,role,model,temperature,system,user,responseSchema=null,responseSchemaName='company_zero_payload'}){
  ...
  if(provider==='groq'&&/^openai\/gpt-oss-/i.test(String(model||'')))body.include_reasoning=false;
  return body;
}
